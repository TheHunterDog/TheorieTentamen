...
//============================= code om Bankbiljet te testen =============================
	...
	public static void main(String[] args) {
        ...
        System.out.println(tientje.equals(tientje));
        System.out.println(tientje.equals(tientje2));
        System.out.println(tienDollar.equals(tienDollar));

        Neutronium naa = new Neutronium("Neutronium");
        Quark qa = new Quark(42);
        System.out.println(naa.straling());
        System.out.println(qa.massa());
	}
